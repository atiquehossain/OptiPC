...
_WIDGET_SPECS: dict[str, WidgetSpec] = {
    ...
    "network_speed": WidgetSpec("network_speed", "Internet Speed", "medium", "accent", "metric_pair"),
    "storage_cleanup": WidgetSpec("storage_cleanup", "Storage Cleanup", "medium", "storage_accent", "action"),
    "disk_io": WidgetSpec("disk_io", "Disk I/O", "medium", "storage_accent", "chart"),
    "network_quality": WidgetSpec("network_quality", "Network Quality", "medium", "accent", "action"),
    "windows_update": WidgetSpec("windows_update", "Windows Update", "medium", "runtime_accent", "action"),
    "storage": WidgetSpec("storage", "Storage", "large", "storage_accent", "meter"),
    "partitions": WidgetSpec("partitions", "Partitions", "large", "storage_accent", "list"),
    "calendar": WidgetSpec("calendar", "Calendar", "large", "calendar_accent", "calendar"),
    "top_processes": WidgetSpec("top_processes", "Top Processes", "large", "accent", "list"),
    "quick_actions": WidgetSpec("quick_actions", "Quick Actions", "large", "accent", "actions"),
    "performance_timeline": WidgetSpec("performance_timeline", "Performance Timeline", "large", "accent", "chart"),
}
