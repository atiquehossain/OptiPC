...
class DashboardPage(BasePage):
    ...
    def build(self) -> None:
        ...
        self.make_action_button(button_frame, f"{DASHBOARD_ICONS['World Clock Widget']} World Clock", lambda: self._open_widget("toggle_world_clock_widget", "World Clock Widget")).grid(row=7, column=2, padx=6, pady=6, sticky="ew")
        # Live CPU Monitor
